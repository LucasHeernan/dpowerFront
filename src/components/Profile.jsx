...
function Profile(props) {
  ...
  let getFilteredPosts = async function () {
    let posts = await axios
      .get('https://dpower-production.up.railway.app/post')
      .then((e) => e.data);
  ...
  return (
    <Provider>
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={refreshing} onRefresh={getImagenes} />}
      >
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.titleBar}>
              ...
              <Menu
                ...
                onDismiss={closeMenu}
                anchor={
                  <IconButton icon='dots-vertical' size={24} color='#52575D' onPress={openMenu} />
                }
              >
